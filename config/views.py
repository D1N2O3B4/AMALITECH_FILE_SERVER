...
def signup(request):
    email_providers = ['gmail.com', 'outlook.com', 'yahoo.com', 'protonmail.com', 'icloud.com', 'aol.com', 'hotmail.com', 'msn.com', 'live.com', 'zoho.com', 'mail.com', 'gmx.com']
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if email_provider in email_providers:
                ...
                messages.error(request, "Invalid email provider.", extra_tags='Invalid email provider')
